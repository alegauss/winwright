...
- [The README](https://github.com/alegauss/winwright#readme) — the full locator grammar, every
  verb family, every field a case may carry, and the reasoning behind each refusal.
