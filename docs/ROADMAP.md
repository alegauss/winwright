...
- 📋 **WW441** (deps: —) **a host that cannot build refuses the guest run as though the desk-free cases were red** — The host lost the SDK global.json pins and dotnet exited 155 before building, yet the refusal said the guest would have said the same thing. → §WW441
