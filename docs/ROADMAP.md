...
- ⏳ **WW88** (deps: Block G ✅, WW76 ✅, WW318 ✅) **pportal carries an interaction harness and twenty-seven copies of one runner** — Its capture case reads that no prompt is up before pressing the row, and the vocabulary has no way to say a thing is not there. → §WW88
