...
internal static class Undrawn
{
    ...
    [
        ...
        new("tray",
            "owns a notification-area icon and no window, and puts up a menu of the kind it was asked for when the shell asks it for one",
            "AdoptedTrayTests.The_menu_a_launched_tray_puts_up_is_opened_by_the_verb_an_adopter_calls"),
        new("profiles",
            "prints the profiles it has, one per line, and exits",
            "ReportedSetTests.The_expected_set_is_what_the_application_says_it_has"),
        new("tab-names",
            "prints its tab headers in the language it was asked for, one per line, and exits",
            "ReportedSetTests.A_read_out_asked_for_the_runs_language_answers_what_the_strings_for_it_declare"),
        new("profile",
            "prints the one profile it is using, and exits",
            "ReportedValueTests.The_value_is_what_the_application_says_it_is"),
        new("sample",
            "makes that read-out answer a value the launch carried rather than the real one",
            "ReportedLocatorTests.A_read_out_is_asked_about_the_machine_the_fixture_put_the_window_on"),
        new("dies",
