...
internal static class Rendered
{
    ...
    [
        ...
        new("SeeThrough.Sentence", "FixtureTests.A_layered_window_at_full_alpha_hides_what_is_behind_it_and_is_not_refused",
        ...
        new("Settled.Sentence", "SettledTests.A_deadline_of_nothing_is_a_reading_that_was_never_taken",
            null, "whether what a run started has left the machine, or was only stopped, or was never waited for"),
        ...
        new("CaseDeclaration.Sentence",
            "CaseCatchesTests.A_case_that_says_nothing_about_why_it_exists_says_so_rather_than_reading_justified",
            null, "the defect a case exists to catch, or that nothing says what deleting it would cost"),
        new("FixtureDeclaration.Sentence",
            "FixtureDeclarationTests.A_fixture_says_what_the_expectations_were_read_against",
            null, "which fixture a case ran against, what it sampled, and whether it may be lent"),
        new("ScenarioSchema.Render", "ScenarioFileTests.The_format_is_readable_before_a_file_is_written",
            null, "what a case may say, before a case is written — the fields and their vocabularies"),
        ...
        new("SuiteVerdict.Render", "SuiteRunTests.The_whole_reading_names_every_case_that_ran_and_every_case_that_did_not",
            null, "the sentence, then a line for every case that ran and every case that did not"),
        new("SuiteVerdict.Sentence", "SuiteRunTests.A_filtered_run_qualifies_its_pass_before_it_states_it",
            null, "what a filtered run concluded, with what it did not run said before the outcome"),
